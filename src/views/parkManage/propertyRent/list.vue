                    ...
                    <div class="col-lg-12">
                        <div class="batch-operation">
                            <div class="batch-operation-group">
                                <a v-link="{name: 'propertyRentEdit'}" class="btn btn-default">费用录入</a>
                        ...
                        <div class="sheet-list-table table-responsive">
                            <table class="table table-condensed panel-group" id="sheet-list" role="tablist">
                                ...
                                <tr class="sheet-list-item">
                                    ...
                                    <td style="text-align:center;">龙席科技</td>
                                    <td>171910619888</td>
                                    <td>龙席科技</td>
                                    ...
                                    <td >物业管理费</td>
                                    <td >3150</td>
                                    <td >就是每月的物业管理费为350元</td>
                                    <td >3150</td>
                                    <td >3150</td>
                                    <td class="state-forbid">
                                        <a v-link="'/propertyRentEdit'"  data-toggle="tooltip" data-placement="top"
                                           title="修改">
                                            <span class="">修改</span>
                                        </a>
...
<!--                                         <a v-link="'msgClassify-update?MessageClassID='+opt.MessageClassID"  data-toggle="tooltip" data-placement="top"
                                ...
                                <tr class="sheet-list-item">
                                    <td><input type="checkbox" value="" v-model="checked"></td>
                                    <td style="text-align:center;">万达广场</td>
                                    <td>13213754209</td>
                                    <td>万达广场</td>
                                    <!-- <td>{{opt.EditTime.split('T')[0]}}1</td> -->
                                    <td >北京市朝阳门外6号7弄</td>
