...
<div class="query-form">
    ...
    <div id="query-detail" class="form-inline query-detail commoditybd commoditybdIssued" @keyup.enter.stop="querys">
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="batch-operation">
                    <label class="batch-operation-title scroll-list-title">门店列表</label>
                ...
                <div class="sheet-list-table table-responsive sheet-list-table-Issued">
                    <table class="table table-condensed panel-group" id="sheet-list" role="tablist">
                        ...
                        <tr class="sheet-list-item">
                            ...
                            <td><span data-toggle="tooltip" data-placement="top" title="{{t.Code}}">{{t.Code}}</span></td>
                            <td>
