<template>
    ...
    <div class="query-form">
        ...
        <div id="query-detail" class="form-inline collapse in query-detail">
            <div class="row" @keyup.enter.stop="search">
                ...
                <div class="form-group col-lg-3 col-md-12 col-sm-12">
                    <label>注册时间</label> <div class="date-wrap">
          ...
          <span class="input-group-addon">
            <span class="glyphicon glyphicon-calendar">
                ...
                <div class="form-group col-lg-3 col-md-12 col-sm-12">
                    <label>过期时间</label> <div class="date-wrap">
          ...
          <span class="input-group-addon">
            <span class="glyphicon glyphicon-calendar">
                ...
                <div class="query-button-group form-group col-lg-12 query-button-search">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="batch-operation">
                    <label class="batch-operation-title scroll-list-title">商家列表</label>
                ...
                <div class="sheet-list-table table-responsive">
                    <table class="table table-condensed panel-group" id="sheet-list" trade="tablist">
                        ...
                        <tr class="sheet-list-item">
                            ...
                            <td><span data-toggle="tooltip" data-placement="top" title="{{trade.BeingDate | truncationTimeString}}">{{trade.BeingDate | formatDateFormShow }}
                            </span></td>

                            <td><span data-toggle="tooltip" data-placement="top" title="{{trade.EndDate | truncationTimeString}}">{{trade.EndDate | formatDateFormShow}}
                            </span></td>
                            ...
                            <td>
                                <a v-link="{name: 'trade-manage-edit',query: { id:trade.MerchantID}}"  data-toggle="tooltip" data-placement="top" title="修改">
                                    <span class="click-element iconfont icon-alter"></span>
                                </a>
                                <a v-link="{name: 'trade-manage-combo-edit',query: { id:trade.MerchantID}}"  data-toggle="tooltip" data-placement="top" title="套餐管理">
                                    <span class="click-element iconfont icon-combo"></span>
                                </a>
                                <a v-link="{name: 'trade-manage-function',query: { id:trade.MerchantID}}"  data-toggle="tooltip" data-placement="top" title="功能配置">
                                    <span class="click-element iconfont icon-trade-function"></span>
                                </a>


                                <a v-if="trade.Status == 1" href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="禁用">
                                    <span class="click-element iconfont icon-forbid" @click="tradeStatusDisable(trade.MerchantID)"></span>
                                </a>

                                <a v-if="trade.Status == -1"  href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="启用">
                                    <span class="click-element iconfont icon-play" @click="tradeStatusEnable(trade.MerchantID)"></span>
                                </a>
                            </td>
                        ...
                        <tr class="sheet-list-detail">
                            <td colspan="12">
                                <div class="panel-collapse collapse sheet-list-collapse" trade="tabpanel" id="sheet-list-detail{{n}}">
