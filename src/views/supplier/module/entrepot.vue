            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="batch-operation">
                        <label class="batch-operation-title scroll-list-title">仓库列表</label>
                    ...
                    <div class="sheet-list-table table-responsive sheet-list-table-Issued">
                        <table class="table table-condensed panel-group" id="sheet-list" role="tablist">
                            ...
                            <tr class="sheet-list-item">
                                ...
                                <!--<td>-->
                                    <!--<a href="javascript:;"  data-toggle="tooltip" data-placement="top" title="编辑">-->
                                    <!--<span class="click-element iconfont icon-alter" v-link="{name: 'entrepot-add', params: {id: tr.StockID}}"></span>-->
                                    <!--</a>-->
                                    ...
                                    <!--<a href="javascript:;"  data-toggle="tooltip" data-placement="top" title="配置运费">-->
                                        <!--<span class="click-element iconfont icon-interface" v-link="{name: 'deploy-freight', params: {id: tr.StockID}}"></span>-->
                                    <!--</a>-->
                                        ...
                                        <div class="sheet-detail-wrap">
                                            <table class="table table-condensed">
                                                ...
                                                <tr>
                                                    <td>{{tr.Code}}</td>
                                                    <td>{{tr.Name}}</td>
                                                    <td>{{tr.StockDetail.LinkMan}}</td>
                                                    <td>{{tr.StockDetail.LinkTel}}</td>
                                                    <td>{{tr.StockDetail.Mobile}}</td>
                                                    <td>{{tr.StockDetail.Email}}</td>
                                                    <td>{{tr.StockDetail.State}}/{{tr.StockDetail.City}}/{{tr.StockDetail.District}}/{{tr.StockDetail.Address}}</td>
                                                </tr>
                                                </tbody> -->
                                            </table>
                                        </div>
