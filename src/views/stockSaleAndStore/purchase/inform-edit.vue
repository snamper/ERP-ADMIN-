            ...
            <div class="col-sm-12">
                ...
                <div class="operate-form-list">
                    ...
                    <div class="form-group form-limit-width">
                        ...
                        <div class='input-group date  inform-edit-width' id='recDate-timepicker'>
                    ...
                    <div class="form-group form-limit-width">
                        ...
                        <div class='input-group date  inform-edit-width' id='PurDate-timepicker'>
                    ...
                    <div class="form-group form-group_table">
                        ...
                        <jxc-detail :vender-id.sync="query.VenderID" :ban-refresh-details.sync="banRefreshDetails" :list.sync="query.BusPlanReceiptGoodInfo_View" :type="2" model-name="inform" submit-url="/BusPlanReceipt/ErpSaveBusPlanReceiptItem" del-url="/BusPlanReceipt/ErpDelBusPlanReceiptItem"></jxc-detail>
                    </div>
    ...
    module.exports = {
        ...
        methods: {
            ...
            postQuery: function () {
                var self = this,
                    data = {
                        PlanReceiptID: this.query.PlanReceiptID,
                ...
                this.$broadcast('submit-before', function (submitType) {
                    if (submitType) {
                        self.query.BusPlanReceiptGoodInfo_View.forEach(function (o, i) {
            ...
            getData:function () {
                ...
                require('../../../js/servers/servers').postAjax({
                    ...
                    data: {
                        PlanReceiptID: this.$route.params.id
                    },
                    success:function (data) {
