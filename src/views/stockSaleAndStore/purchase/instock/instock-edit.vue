            ...
            <div class="col-sm-12">
                ...
                <div class="operate-form-list">
                    <div class="form-group form-limit-width stock-upsheet">
                        <label class="form-group-text">上游单据</label>
                        ...
                        <div class="stock-upsheet-wrap" v-if="isShowUpSheetList">
                            <ul class="stock-upsheet-list">
                                <li class="stock-upsheet-item" @click.stop="selectUpSheet(upSheet)" v-for="upSheet in  upSheetList">{{upSheet.Sheet}}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-limit-width">
                        <label class="form-group-text">计划入库<span class="form-required-mark">*</span></label>
                            ...
                            <div class="sheet-list-table table-responsive sheet-list-margin">
                                <table class="table table-condensed">
                                    <thead class="sheet-list-header">
                                        <tr>
                                            <th class="new-newly-instorck"><a href="javascript:void(0)" @click="addMerchant" class="btn btn-default new-newly " style="line-height:16px;">+ &nbsp;新增</a></th>
                                            <th>商品</th>
                                            <th>SKU</th>
                                            <th>商品名称</th>
                                            <th>尺码</th>
                    ...
                    <div class="operate-form-buttons">
                        ...
                        <a v-link="{name:'purchase-instock'}" class="btn btn-default">返回列表>></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    module.exports = {
        ...
        methods: {
            choiceCustomNo: function (CustomNo,merchant) {
                var queryData = {
                    customNo: CustomNo,
                    VenderID: this.busInStock.OutID,
//                    customBC: '',
                    merchant: merchant
                };
                ...
                servers.postAjax.bind(this)({
                    ...
                    if (result.ResultCode == 1) {
                        ...
                        if (inStock) {
                            ...
                            busInStock.PurDate = inStock.PurDate;
...
//                            });
            ...
            selectUpSheet: function (upSheet) {
                var upSheetItems = upSheet.BusPlanReceiptGoodInfo_View;
            ...
            detailUpload: function () {
                this.$dispatch('transmit', 'detailUploadModalShow',23);
            }
        },
        ready: function () {
            this.getBaseLookUp();
...
//                locale: 'zh-cn'
        ...
        route: {
            data: function (transition) {
                ...
                if (name == 'purchase-instock-edit') {
                    this.pageInfo.text = '修改入库单';
