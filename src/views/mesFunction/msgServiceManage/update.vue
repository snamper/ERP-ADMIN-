            ...
            <div class="col-sm-12">
                ...
                <div class="dade">
                    ...
                    <div class="divFloat min520">
                        ...
                        <div class="positi">
                            <span v-for="(index,item) in NetShopIDLIts" class="check-span" @click="onClickShift(index)">{{item.NetShopName}} &times;</span>
                        </div>
    ...
    module.exports = {
        ...
        methods: {
            chooseMedicine: function(obj){
                ...
                $this.NetShopIDLIts.push({
                    NetShopID:obj.NetShopID,
                    NetShopName:obj.Name
                })
            },
            ...
            //查询详情 
            erpQueryCustomServiceDetail:function(){
                var self = this;
                //this.choiceParams();
                NProgress.start();
                servers.getAjax.bind(this)({
                    url: '/BasCustomService/ErpQueryCustomServiceDetail',
                    data: {
                        customServiceID:self.delivery.CustomServiceID
                    }
                }).done(function (result) {
                    NProgress.done();
                    if ( result.ResultCode == 1 ) {
                        console.log(result.Data)
                        self.delivery = result.Data;
                        self.NetShopIDLIts = result.Data.customServiceShopList;
                        //console.log(self.NetShopIDLIts)
                    }
                });
            },
            //修改按钮
            erpSaveCustomService: function () {
                ...
                var self = this;
                self.delivery.customServiceShopList =[];
                ...
                //self.delivery.ShopIDList = JSON.stringify(self.delivery.customServiceShopList);                
        ...
        route: {
            data: function (transition) {
                ...
                this.delivery.CustomServiceID = transition.to.query.CustomServiceID;
                //console.log(this.delivery.CustomServiceID)
                this.erpQueryCustomServiceDetail()
            }
        },    
        ready: function () {
            this.getLoginerList();
