                ...
                <div class="modal-content wrap">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">修改仓库</label>
                            <select class="form-control" v-model="stockID">
                                <option v-for="stock in stockList" value="{{stock.StockID}}">{{stock.Name}}</option>
                            </select>
                        </div>
                        <p>注意:系统会根据仓库库存情况修改默认快递</p>
                    </div>
...
<script>
    ...
    module.exports = {
        ...
        methods: {
            ...
            updateStock: function () {
                ...
                servers.postAjax.bind(this)({
                    url: '/BusCustomerOrder/ErpCustomerOrderUpdateStock',
                    contentType: 'application/json',
                    data: JSON.stringify(updateStockData)
        ...
        events: {
             ...
             */
            'modal-stock': function (modalStockData,customerOrder) {
                this.showModal();
                this.stockList = modalStockData.stockLists;
                this.customerIDGroup = modalStockData.customerIDGroup;
                if (customerOrder) {
                    this.stockID = customerOrder.StockID;
                } else {
                    this.stockID = '';
                }
            }
