...
<script>
    ...
    module.exports = {
        ...
        methods: {
            ...
            updateMerchantDelivery: function () {
                ...
                servers.postAjax.bind(this)({
                    url: '/BusCustomerOrder/ErpCustomerOrderUpdateMerchantDelivery',
        ...
        events: {
             ...
             */
            'modal-delivery': function (modalMerchantDeliveryData,customerOrder) {
                this.showModal();
                this.customerIDGroup = modalMerchantDeliveryData.customerIDGroup;
                this.deliveries = modalMerchantDeliveryData.merchantDeliveryLists;
                if (customerOrder) {
                    this.merchantDeliveryID = customerOrder.OrderFlag.MerchantDeliveryID;
                } else {
                    this.merchantDeliveryID = '';
                }
            }
        }
    }
