                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12 takeDelivery">
                                    <label >收货区域</label>
                                    <input v-model="formData.Country" type="text" class="form-control"  placeholder="国家"><!--新增国家 -->
...
<script>
    ...
    module.exports = {
        ...
        methods: {
            ...
            updateAddress: function () {
                ...
                servers.postAjax.bind(this)({
                    url: '/BusCustomerOrder/UpdateAddress',
        ...
        events: {
            'modal-address': function (customerIDGroup,customerOrder) {
                this.showModal();
