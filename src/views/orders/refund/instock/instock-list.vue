    ...
    <div class="col-lg-12">
        <div class="batch-operation">
            ...
            <div class="batch-operation-group">
                <a v-link="{name:'refund-instock-add'}" class="btn btn-default">新增</a>
            ...
            <table class="table table-condensed panel-group" id="sheet-list" role="tablist">
                ...
                <tr class="sheet-list-item">
                    ...
                    <td>
                        ...
                        <a v-if="inStock.Flag == 0 || inStock.Flag == 10" v-link="{name:'refund-instock-edit',query:{inStockID:inStock.InStockID}}" href="javascript:void(0)" class="sheet-list-edit"  data-toggle="tooltip" data-placement="top" title="编辑"><span class="iconfont icon-alter"></span></a>
                    </td>
                </tr>
