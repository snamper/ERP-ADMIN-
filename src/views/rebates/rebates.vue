                ...
                <div class="col-lg-12">
                    <div class="batch-operation">
                        <div class="batch-operation-group">
                            <label>批量操作：</label>
                            <a @click="StatusEnable( )" href="javascript:void(0)" class="btn btn-default">批量操作</a>
                    ...
                    <div class="sheet-list-table table-responsive">
                        <table class="table table-condensed panel-group" id="sheet-list" role="tablist">
                            ...
                            <tr class="sheet-list-item">
                                ...
                                <td>
                                    <a v-link="{name: 'returnRecord'}" data-toggle="tooltip" data-placement="top" title="返还记录">
                                        <span class="click-element iconfont icon-look"></span>
                                    </a>
                                    <a data-toggle="tooltip" data-placement="top" title="提成记录">
                                        <span v-link="{name: 'rebateRecord'}" class="click-element iconfont icon-combo"></span>
                                        <!--<span v-link="{name: 'deal-flow', query: {AccountID: opt.AccountID,Name: opt.Name}}" class="click-element iconfont icon-combo"></span>-->
                                    </a>
                                </td>
                            </tr>
