        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a @click="autoGenerateSheet" href="javascript:void(0)" @click="" class="btn btn-default">一键生成运单号</a>
            ...
            'modal-delivery-sheet': function (customerGroup) {
                ...
                customerGroup.forEach(function (customer) {
                    self.customerGroup.push({
                        OutStockID: customer.OutStock.OutStockID,
                        Sheet: customer.OutStock.Sheet,
                        DeliverySheetID: customer.OutStock.OutStockFlag.DeliverySheetID,
                        OrderNo: customer.OrderNo,
                        LinkMan: customer.OutStock.LinkMan,
                        MerchantDeliveryID: customer.OutStock.MerchantDelivery.MerchantDeliveryID,
                        Code: customer.OutStock.MerchantDelivery.Delivery.Code
                    })
                });
