                ...
                <div class="col-lg-12">
                    <div class="sheet-tab">
                        <div class="sheet-state">
                            <a v-link="{name:'assort-pick-edit-list',params:{outStockBatchID:outStockBatchID},query:{code: pageStatusCode},activeClass:'active'}" class="sheet-tab-link active">订单列表</a>
                            <a v-link="{name:'assort-pick-edit-merchant',params:{outStockBatchID:outStockBatchID},query:{code: pageStatusCode},activeClass:'active'}" class="sheet-tab-link ">商品清单</a>
                        </div>
                    </div>
                </div>
                <router-view :pay-mode="outStockBatch.PayMode" :merchant-delivery-id="outStockBatch.MerchantDelivery.MerchantDeliveryID" :shop-id="outStockBatch.Shop.ShopID" :sheet="outStockBatch.Sheet" :code="pageStatusCode" :out-stock-batch-items.sync="outStockBatch.OutStockBatchItems" :out-stock-batch-merchant.sync="outStockBatchMerchant"></router-view>
            </div>
        </div>
    </div>
</template>
