                ...
                <div class="col-lg-12">
                    <div class="batch-operation">
                        ...
                        <div class="batch-operation-group">
                             <a v-if="isPreCheck" class="btn btn-default" @click="preCheck('')">确认</a>
                             <a class="btn btn-default" @click="operateCheckList(true)">同意</a>
                             <a class="btn btn-default" @click="operateCheckList(false)">驳回</a>
                             <a class="btn btn-default" @click="importDeliverySheet">导入运单</a>
                             <a class="btn btn-default" @click="directOutStock">直接发货</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
    ...
    module.exports = {
        ...
        methods: {
            ...
            operateCheckList (type) {
                const text =  type ? '同意' : '驳回';
                const url = type ? '/BusDistributorOrder/ErpComputerCompleteBatch' : '/BusDistributorOrder/ErpComputerCancelBatch';
                if (this.checkedGroups.length === 0) {
            ...
            cancelOrder: function (id,flag) {
                ...
                self.$once('cancelOrder',function () {
                    NProgress.start();
                    servers.postAjax.bind(this)({
                        url: '/BusDistributorOrder/ErpComputerCanCel',
                        data: {
