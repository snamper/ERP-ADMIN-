          ...
          <div class="col-sm-12">
              <div class="operate-form-list">
                  ...
                  <div class="form-group form-limit-width">
                      ...
                      <select-area :state-id.sync="form.CustomerDetail.State" :city-id.sync="form.CustomerDetail.City" :district-id.sync="form.CustomerDetail.District" :options="{isShowCity:true,isShowDistrict:true}"></select-area>
                  </div>
                  <div class="form-group form-limit-width">
        ...
        methods:
            ...
            getcustomerTypeList: () ->
                ...
                servers.getAjax
                    ...
                    success: (data) ->
                        self.customerTypeList = data.Data
            ...
            getCustomerGradeList: () ->
                ...
                servers.getAjax
                    ...
                    success: (data) ->
                        self.customerGradeList = data.Data
                ...
                servers.postAjax.bind(this)
                    ...
                    success: (data) ->
                        if data.ResultCode is 1
                            self.$dispatch 'transmit', 'tip', contentText: '新增成功！'
