//先清空 n-build 文件夹下的文件
var fs = require('fs'),buildPath='./App_Modules/';
...
var plugins = [
  ...
  function(){
      return this.plugin('done', function(stats) {
        ...
        return fs.writeFileSync('App_Modules/assets.json', content);
      });
  }
];
...
module.exports = {
    ...
    module: {
        ...
        loaders: [
            ...
            {test: path.resolve(node_modules_dir,'jquery/jquery.min.js'),loader: "expose?$!expose?jQuery"}
    ...
    //     host: 'localhost',
    //     proxy: {
    //         "/Api/*": "http://192.168.88.20:8088",
    //         // "/Api/*": "http://gzwolfsoft.oicp.net:8088",
    //     }
    // },
    // resolve: {
